...
function AppointmentsPage() {
    const { appointments, updateAppointmentStatus, barbers, services, units, refreshAppointments } = useAdmin();
    ...
    const filteredAppointments = appointments.filter(apt => {
        ...
        const barberName = (apt.barberName || '').toLowerCase();
                            ...
                            {filteredAppointments.length === 0 ? (
                                <tr>
                                    <td colSpan="8" className="text-center text-secondary py-8">
                                        <i className="fas fa-calendar text-4xl mb-4 opacity-30 block"></i>
                                ...
                                filteredAppointments.map((apt) => {
                                    ...
                                    return (
                                        <tr key={apt.id}>
                                            ...
                                            <td>{apt.serviceName || 'Serviço'}</td>
                                            <td>{apt.barberName || 'Barbeiro'}</td>
                                            <td>
                                                <div>
                                                    <p>{apt.date || '-'}</p>
                                            ...
                                            <td className="font-semibold text-primary">R$ {(apt.price || 0).toFixed(2)}</td>
                                            <td>
